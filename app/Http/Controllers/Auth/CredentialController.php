...
class CredentialController extends Controller
{
    ...
    public function onLogin(Request $request)
    {
        ...
        if (/*Auth::attempt(['employee_id' => $fields['employee_id'], 'password' => $fields['password']])*/ true) {
            ...
            //     ];
            return ResponseBuilderHelper::dataResponse('success', 200, ResponseMessageHelper::onAuthenticate('Login', 1), 'hello world');
        } else {
