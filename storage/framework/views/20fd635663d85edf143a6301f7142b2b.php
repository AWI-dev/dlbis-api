            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <img class="img-fluid" src="<?php echo e(asset('img/login_shoo.png')); ?>" alt="" width="300">
                    </div>
                    <div class="col-md-6 col-sm-12">
...
<?php /**PATH C:\laragon\www\mg-api\resources\views/livewire/user/login.blade.php ENDPATH**/ ?>